...
<?php 
   ...
   switch($ct)
   {
      case "the_daily":
         ...
         {
            ?>
            <figure class="the-daily-right">
               <?php print $fields['field_image']->content; ?> 

               <figcaption class="daily-caption">
            ...
            ?>
               <article class="bigger-story js-story">
                  ...
                  <div class="story-blurb"><?php print $fields['field_blurb']->content; ?></div>
                     ...
                     <p class="commitment"><i class="article-commitment"></i><?php print $fields['field_commitment']->content ?></p>
                  </div>
               </article>
            <?php
         }
               ...
               ?>
                  <article class="ls-right js-story">
                     ...
                     <div class="story-caption">
                        ...
                        <h2 class="story-title"><?php print $fields['title']->content; ?></h2>
                        <div class="story-blurb"><?php print $fields['field_blurb']->content; ?></div>
                        <p class="commitment"><i class="video-commitment"></i><?php print $fields['field_commitment']->content ?></p>
                     </div>
                  </article>
               <?php
            }
