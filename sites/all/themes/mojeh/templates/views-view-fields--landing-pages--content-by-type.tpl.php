               ...
               <article class="bigger-story js-story">
                  ...
                  <div class="story-caption">
                     ...
                     <div class="story-blurb">
                        <?php print $fields['field_blurb']->content; ?>
                     </div>
                     <p class="commitment"><a href="<?php print $fields['path']->content; ?>"><i class="article-commitment"></i><?php print strip_tags(render($fields['field_commitment']->content)); ?></a></p>
                  </div>
               </article>
            <?php
         }
               ...
               ?>
                  <article class="ls-right js-story">
                     ...
                     <div class="story-caption">
                        ...
                        <h2 class="story-title"><?php print $fields['title']->content; ?></h2>
                  <div class="story-blurb"><?php print $fields['field_blurb']->content; ?></div>
                        <p class="commitment"><a href="<?php print $fields['path']->content; ?>"><i class="video-commitment"></i><?php print strip_tags(render($fields['field_commitment']->content)); ?></a></p>
                     </div>
                  </article>
               <?php
            }
