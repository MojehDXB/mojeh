...
$vdata = json_decode(file_get_contents('http://vimeo.com/api/v2/video/' . $video_id . '.json'));
if(count($vdata) == 1)
{
   $width = $vdata[0]->width;
...
<div class="<?php print $classes; ?> media-vimeo-<?php print $id; ?>">
  <iframe class="media-vimeo-player" <?php print $api_id_attribute; ?>width="<?php print $width; ?>" height="<?php print $height; ?>" title="<?php print $title; ?>" src="<?php print $url; ?>" frameborder="0"><?php print $alternative_content; ?></iframe>
</div>
